	...
	current_node->FindNeighbors();
  	for(auto node: current_node->neighbors){
    	node->parent = current_node;
      	...
      	float d = current_node->distance(*node);
      	node->g_value = current_node->g_value + d;
      	node->visited = true;
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    {
      float nodeASum = nodeA->h_value + nodeA->g_value;
      float nodeBSum = nodeB->h_value + nodeB->g_value;
